...
\hypersetup{unicode=true,
            pdftitle={Is metacognition a general mechanism?},
            pdfborder={0 0 0},
            breaklinks=true}
...
\includegraphics{capstone_metacognition_md_files/figure-latex/Nsubj by Category-1.pdf}

\hypertarget{confidence}{%
\subsection{Confidence}\label{confidence}}

\includegraphics{capstone_metacognition_md_files/figure-latex/confidence-1.pdf}
...
\includegraphics{capstone_metacognition_md_files/figure-latex/Confidence and response speed by Category-1.pdf}
...
\includegraphics{capstone_metacognition_md_files/figure-latex/Confidence and accuracy by Category-1.pdf}
