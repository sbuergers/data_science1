...
# charge groups. Are these differences statistically significant? 
#
...
#
# Q6 --- what is the projected number of felony arrests in 2019? Round to the nearest integer. 
#
...
#
# Q9 --- Calculate ]the ratio of the conditional probability of an arrest 
